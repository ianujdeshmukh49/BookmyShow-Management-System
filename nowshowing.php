...
<body style="background-color: powderblue; font-family: monospace; margin: 0; padding: 0;">
	...
	<h1 align="middle" style="font-size: 250%; color:white;"><br><b>
			<?php echo $_SESSION['mov_name']; ?>
		</b></h1>
	...
	<form align="middle" action="includes/booking.php" method="POST">
		<div class="form-group">
			...
			<input style=" width:200px; margin-left: 42%;" type="number" name="seats" placeholder="No of Seats"
				class="form-control"><br><br>
			<button style="border:1px solid black; font-family:monospace; color:black; font-style:bold; font-size:20px;"
				type="submit" class="btn btn-success" name="submit"> Confirm <span
